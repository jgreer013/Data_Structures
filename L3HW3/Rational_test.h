...
public:
  ...
  // Add unit tests for division here!!!
  void testDiv1(){
    TS_ASSERT_EQUALS(*two / *one, *two)
  }
  
  void testDiv2(){
    TS_ASSERT_EQUALS(*one / *two, *half)
  }
  
  void testDiv3(){
    TS_ASSERT_EQUALS(*zero / *third, *zero)
  }
  
  void testDiv4(){
    TS_ASSERT_EQUALS(*half / *third, Rational(3,2))
  }
  
  void testDiv5(){
    TS_ASSERT_EQUALS(*one / 2, *half)
  }
};
